...
create table user (id bigint not null, correct_count integer, end_status varchar(255), room_code varchar(255), user_name varchar(255), user_order integer, user_role integer, askingYn varchar(255), primary key (id));